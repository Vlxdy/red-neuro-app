          ...
          return Dialog(
            child: ConfirmationDialog(
              ...
              onConfirm: () async {
                ...
                if (error != null) {
                  showSnackBar(modificarPinSeguridadMessenger, error,
                    ...
                    onTap: () async {
                      if (validateForm(_scaffoldingFormKey)) {
                        ...
                        if (pinActual != _currentPinSeguridad.text) {
                          showSnackBar(modificarPinSeguridadMessenger,
                        ...
                        await Seguridad.instance
                            .updateSecurityPin(_pinSeguridad.text);
